...
const t = {
  en: {
    title: 'Privacy at Ponoi — What Data Ponoi Collects',
    desc: 'Exactly what data Ponoi handles: email, username, messages, attachments, calls, device information — what is collected, why, how long it is kept and who can see it.',
    h1: 'Privacy at Ponoi',
    lede: 'Not a legal document written to be unreadable. This is a list of every kind of data Ponoi touches, why it exists, and who can reach it.',
    updated: 'Last updated',

    shortH: 'The short version',
    short1: 'Ponoi has no analytics, no crash reporting service and no advertising code. Nothing counts you.',
    ...
    rows: [
      ...
      ['Password', 'Yes, as a hash',
        ...
        'Nobody. Stored as a bcrypt hash by Supabase Auth; Ponoi writes no password storage of its own.'],
      ...
      ['IP address', 'Not stored by Ponoi',
        'Unavoidable for any network connection',
        'Whatever the infrastructure providers keep in their own logs',
        'The services listed below, as part of serving the request. Ponoi has no table of IP addresses.'],
    ...
    thirdP: 'Ponoi is not self-hosted. These services take part in making it work, and each of them at minimum sees the IP address of the device that connects to it.',
    ...
    thirdNote: 'The app does not load fonts from a font CDN: they are bundled, specifically so that starting Ponoi does not report your IP address to a third party before you have even signed in.',
  ...
  ru: {
    title: 'Приватность Ponoi — какие данные собирает Поной',
    desc: 'Что именно за данные обрабатывает Ponoi (Поной): почта, имя, сообщения, вложения, звонки, сведения об устройстве — что собирается, зачем, сколько хранится и кому доступно.',
    h1: 'Приватность в Ponoi',
    lede: 'Это не юридический документ, написанный, чтобы его не читали. Это перечень всех видов данных, которых Ponoi касается, зачем они нужны и кто может до них добраться.',
    updated: 'Обновлено',

    shortH: 'Коротко',
    short1: 'В Ponoi нет ни аналитики, ни службы сбора падений, ни рекламного кода. Вас никто не считает.',
    ...
    rows: [
      ...
      ['Пароль', 'Да, в виде хеша',
        ...
        'Никому. Хранится как хеш bcrypt в Supabase Auth; собственного хранения паролей в Ponoi нет.'],
      ...
      ['IP-адрес', 'Ponoi его не хранит',
        'Неизбежен для любого сетевого соединения',
        'Столько, сколько его держат в своих журналах поставщики инфраструктуры',
        'Перечисленным ниже службам — в рамках обработки запроса. Таблицы с IP-адресами в Ponoi нет.'],
    ...
    thirdP: 'Ponoi не держит свою инфраструктуру. Эти службы участвуют в его работе, и каждая из них как минимум видит IP-адрес устройства, которое к ней подключается.',
    ...
    thirdNote: 'Шрифты приложение с чужого CDN не грузит: они лежат в сборке — именно затем, чтобы запуск Ponoi не сообщал ваш IP постороннему ещё до входа в учётную запись.',
