...
const qa = {
  en: [
    ['What is NeyLivo?',
      'NeyLivo is a messenger and communication platform. You write to people directly, build servers with channels for a community, call each other with video and screen sharing, listen to music together and extend the app with plugins. It runs on Windows, Android and in a browser.'],
    ['What is Нейливо?',
      'Нейливо is the same product, spelled in Cyrillic. NeyLivo and Нейливо are two spellings of one name — one app, one account, one website.'],
    ['Is NeyLivo a messenger?',
    ...
    ['Is NeyLivo end-to-end encrypted?',
      'Partly, and only if you turn it on. End-to-end encryption covers direct messages between two people, their attachments and their calls — three separate switches, all off by default. Group conversations and server channels are not end-to-end encrypted: they are protected by access rules in the database instead. Calling NeyLivo “an end-to-end encrypted messenger” without those qualifications would be misleading, so we do not.'],
    ['Is NeyLivo anonymous?',
    ...
    ['What data does NeyLivo collect?',
    ...
    ['Who develops NeyLivo?',
      'NeyLivo is an independent project developed in the open by NeyLivo on GitHub. There is no company behind it, no funding and no investors.'],
    ['Where can I download NeyLivo?',
    ...
    ['Does NeyLivo have an Android app?',
      'Yes. It is installed from an APK file downloaded here — NeyLivo is not on Google Play. Android will ask you to allow installing apps from that source, which is the normal prompt for any app outside the store. You should not need to disable any system protection.'],
    ['Does NeyLivo have a Windows app?',
    ...
    ['Can I use NeyLivo in a browser?',
    ...
    ['What is a .neylivo file?',
      'The format a NeyLivo plugin comes in: a single JavaScript file with a header comment describing the plugin’s name, author, version, permissions and the domains it may contact. You can install one from a file, or receive it in a conversation as a card with an Install button.'],
    ['What is Trackoteka?',
      'Trackoteka (Трекотека) is NeyLivo’s built-in music system: a shared library of tracks, playlists, a queue, synced lyrics and listening together in a lobby where everyone hears the same thing at the same moment.'],
    ['How is NeyLivo different from Discord?',
      'The structure is familiar — servers, channels, roles, voice. The differences are that NeyLivo can end-to-end encrypt one-to-one conversations, has no analytics or advertising, is free with no paid tier, and lets you extend the app with your own plugins that run sandboxed in the client. Discord is a large funded product with moderation, scale and reliability that an independent project does not match.'],
    ['How is NeyLivo different from Telegram?',
      'Both offer optional end-to-end encryption for one-to-one chats rather than by default. NeyLivo is organised around servers and channels rather than channels and groups, is much smaller, and is extensible with client-side plugins. Telegram has enormous reach, its own infrastructure and years of operational maturity; NeyLivo has none of that yet.'],
    ['How is NeyLivo different from Signal?',
      'Signal is an encrypted messenger first: end-to-end encryption is on by default, for everything, including group chats and calls, using a protocol reviewed by cryptographers for years. NeyLivo does not match that and does not claim to — encryption here is optional and covers one-to-one conversations only. What NeyLivo offers instead is communities, music and plugins in one app. If your priority is the strongest available message privacy, use Signal.'],
    ['Is NeyLivo safe to use?',
  ...
  ru: [
    ['Что такое Нейливо?',
      'Нейливо (NeyLivo) — мессенджер и платформа для общения. В нём пишут людям напрямую, собирают серверы с каналами под сообщество, созваниваются с видео и демонстрацией экрана, слушают музыку вместе и расширяют приложение плагинами. Работает на Windows, Android и в браузере.'],
    ['Что такое NeyLivo?',
      'Это то же самое, только латиницей. NeyLivo и Нейливо — два написания одного названия: одно приложение, одна учётная запись, один сайт.'],
    ['Нейливо — это мессенджер?',
    ...
    ['Кто разрабатывает NeyLivo?',
      'NeyLivo — независимый проект, который разрабатывается открыто; автор — NeyLivo на GitHub. За ним нет компании, финансирования и инвесторов.'],
    ['Где скачать Нейливо?',
    ...
    ['Есть ли приложение NeyLivo для Android?',
    ...
    ['Есть ли приложение NeyLivo для Windows?',
    ...
    ['Можно ли пользоваться NeyLivo в браузере?',
    ...
    ['Что такое файл .neylivo?',
      'Это формат, в котором приходит плагин NeyLivo: один файл на JavaScript с комментарием в начале, где указаны название, автор, версия, разрешения и домены, к которым плагину можно обращаться. Такой файл можно поставить с диска или получить в беседе карточкой с кнопкой «Установить».'],
    ['Что такое Трекотека?',
      'Трекотека — встроенная музыкальная система NeyLivo: общая библиотека треков, плейлисты, очередь, синхронный текст песни и совместное прослушивание в лобби, где все слышат одно и то же в один момент.'],
    ['Чем NeyLivo отличается от Discord?',
      'Устройство знакомое — серверы, каналы, роли, голос. Отличия в том, что NeyLivo умеет сквозное шифрование переписки один на один, в нём нет аналитики и рекламы, он бесплатный без платного уровня, и приложение расширяется своими плагинами, которые работают в песочнице прямо у вас. Discord — большой профинансированный продукт с модерацией, масштабом и надёжностью, которых у независимого проекта нет.'],
    ['Чем NeyLivo отличается от Telegram?',
      'В обоих сквозное шифрование для переписки один на один — по выбору, а не по умолчанию. NeyLivo построен вокруг серверов и каналов, а не каналов и групп, он гораздо меньше и расширяется плагинами на стороне клиента. У Telegram огромный охват, своя инфраструктура и годы работы под нагрузкой; у NeyLivo ничего этого пока нет.'],
    ['Чем NeyLivo отличается от Signal?',
      'Signal прежде всего шифрованный мессенджер: сквозное шифрование там включено по умолчанию и на всё, включая групповые чаты и звонки, по протоколу, который криптографы разбирают годами. NeyLivo этого уровня не достигает и не заявляет: шифрование здесь по выбору и только для переписки один на один. Взамен NeyLivo даёт сообщества, музыку и плагины в одном приложении. Если для вас важнее всего защищённость переписки — пользуйтесь Signal.'],
    ['Безопасно ли пользоваться NeyLivo?',
...
const t = {
  en: {
    title: 'NeyLivo FAQ — Questions About NeyLivo Messenger',
    desc: 'Answers about NeyLivo (Нейливо): what it is, whether it is free, whether it is encrypted or anonymous, where to download it, what plugins and Trackoteka are, and how it compares to Discord, Telegram and Signal.',
  ...
  ru: {
    title: 'Вопросы о Нейливо — FAQ мессенджера NeyLivo',
    desc: 'Ответы о NeyLivo (Нейливо): что это, бесплатный ли, шифруется ли переписка, анонимен ли он, где скачать, что такое плагины и Трекотека, чем отличается от Discord, Telegram и Signal.',
    h1: 'Вопросы и ответы',
...
<section class="wrap">
  <div class="qa">
    ...
    <p><a href="${urlFor('download', lang)}">${lang === 'en' ? 'Download NeyLivo' : 'Скачать NeyLivo'} →</a>
